...
def test_canonical_capability_wheel_contains_isolated_import_surface(tmp_path: Path) -> None:
    ...
    with ZipFile(wheel_path) as wheel:
        ...
        wheel_metadata = wheel.read("vulca-0.24.0.dist-info/WHEEL")
        distribution_metadata = wheel.read("vulca-0.24.0.dist-info/METADATA")
    ...
    assert parsed_metadata["Version"] == "0.24.0"
